...
public class AbsencesApiGenerated {
    ...
    private okhttp3.Call createNewAbsenceCall(CreateAbsenceCommand createAbsenceCommand, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = createAbsenceCommand;

        // create path and map variables
        String localVarPath = "/attendance/absences";
    ...
    private okhttp3.Call createNewAbsenceValidateBeforeCall(CreateAbsenceCommand createAbsenceCommand, final ApiCallback _callback) throws ApiException {
        return createNewAbsenceCall(createAbsenceCommand, _callback);

    }


    private ApiResponse<String> createNewAbsenceWithHttpInfo(CreateAbsenceCommand createAbsenceCommand) throws ApiException {
        okhttp3.Call localVarCall = createNewAbsenceValidateBeforeCall(createAbsenceCommand, null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createNewAbsenceAsync(CreateAbsenceCommand createAbsenceCommand, final ApiCallback<String> _callback) throws ApiException {

        okhttp3.Call localVarCall = createNewAbsenceValidateBeforeCall(createAbsenceCommand, _callback);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

    public class CreateNewAbsenceRequestBuilder {
        ...
        private CreateNewAbsenceRequestBuilder() {
        }

        /**
         * Set employeeId
         * @param employeeId The ID of the Employee. &lt;br /&gt;  Must exist in the Employees Service. &lt;br /&gt;  Cannot be updated once Absence created. (optional)
         * @return CreateNewAbsenceRequestBuilder
         */
        public CreateNewAbsenceRequestBuilder employeeId(String employeeId) {
        ...
        /**
         * Set absenceReasonId
         * @param absenceReasonId The Absence Reason ID. &lt;br /&gt;  Must exist in the Attendance Absence Reasons Service. &lt;br /&gt;  Cannot be updated once Absence created. (optional)
         * @return CreateNewAbsenceRequestBuilder
         */
        public CreateNewAbsenceRequestBuilder absenceReasonId(String absenceReasonId) {
        ...
        /**
         * Set narrative
         * @param narrative The Narrative relating to the Attendance. &lt;br /&gt;  Cascade Source: [EmployeeAttendance].[Narrative] (optional)
         * @return CreateNewAbsenceRequestBuilder
         */
        public CreateNewAbsenceRequestBuilder narrative(String narrative) {
        ...
        /**
         * Set startDate
         * @param startDate The Start Date of the Attendance. &lt;br /&gt;  Cascade Source: [EmployeeAttendance].[StartDate] (optional)
         * @return CreateNewAbsenceRequestBuilder
         */
        public CreateNewAbsenceRequestBuilder startDate(OffsetDateTime startDate) {
        ...
        /**
         * Set endDate
         * @param endDate The End Date of the Attendance. &lt;br /&gt;  Cascade Source: [EmployeeAttendance].[EndDate]  Null if Opened Ended - Cascade Source: [EmployeeAttendance].[OpenEnded] (optional)
         * @return CreateNewAbsenceRequestBuilder
         */
        public CreateNewAbsenceRequestBuilder endDate(OffsetDateTime endDate) {
            this.endDate = endDate;
            return this;
        }
        
        /**
         * Build call for createNewAbsence
        ...
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            CreateAbsenceCommand createAbsenceCommand = buildBodyParams();
            return createNewAbsenceCall(createAbsenceCommand, _callback);
        }

        private CreateAbsenceCommand buildBodyParams() {
            CreateAbsenceCommand createAbsenceCommand = new CreateAbsenceCommand();
            createAbsenceCommand.employeeId(this.employeeId);
            createAbsenceCommand.absenceReasonId(this.absenceReasonId);
            createAbsenceCommand.narrative(this.narrative);
            createAbsenceCommand.startDate(this.startDate);
            createAbsenceCommand.endDate(this.endDate);
            return createAbsenceCommand;
        }

        /**
         * Execute createNewAbsence request
         * @return String
        ...
        public String execute() throws ApiException {
            CreateAbsenceCommand createAbsenceCommand = buildBodyParams();
            ApiResponse<String> localVarResp = createNewAbsenceWithHttpInfo(createAbsenceCommand);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute createNewAbsence request with HTTP info returned
        ...
        public ApiResponse<String> executeWithHttpInfo() throws ApiException {
            CreateAbsenceCommand createAbsenceCommand = buildBodyParams();
            return createNewAbsenceWithHttpInfo(createAbsenceCommand);
        }

        /**
         * Execute createNewAbsence request (asynchronously)
        ...
        public okhttp3.Call executeAsync(final ApiCallback<String> _callback) throws ApiException {
            CreateAbsenceCommand createAbsenceCommand = buildBodyParams();
            return createNewAbsenceAsync(createAbsenceCommand, _callback);
        }
    }
     ...
     */
    public CreateNewAbsenceRequestBuilder createNewAbsence() throws IllegalArgumentException {
        return new CreateNewAbsenceRequestBuilder();
    }
    private okhttp3.Call deleteByIdCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/attendance/absences/{id}"
     ...
     * ![Beta](https://img.shields.io/badge/Status-Beta-yellow) &lt;b&gt;This API request method is currently in beta testing.&lt;/b&gt; To gain access to use this method, please contact &lt;a href&#x3D;&#39;mailto:hrapi@iris.co.uk&#39;&gt;hrapi@iris.co.uk.&lt;/a&gt;
     * @param id The ID of the Absence to delete. (required)
    ...
    private ApiResponse<AbsenceModel> getByIdWithHttpInfo(String id) throws ApiException {
        okhttp3.Call localVarCall = getByIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<AbsenceModel>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getByIdAsync(String id, final ApiCallback<AbsenceModel> _callback) throws ApiException {
    ...
    public class GetByIdRequestBuilder {
         ...
         */
        public AbsenceModel execute() throws ApiException {
            ApiResponse<AbsenceModel> localVarResp = getByIdWithHttpInfo(id);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getById request with HTTP info returned
         * @return ApiResponse&lt;AbsenceModel&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<AbsenceModel> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<AbsenceModel> _callback) throws ApiException {
    ...
    private ApiResponse<AbsenceQueryModel> getListWithHttpInfo(Integer $top, Integer $skip, String $filter, List<String> $select, String $orderby, Boolean $count) throws ApiException {
        okhttp3.Call localVarCall = getListValidateBeforeCall($top, $skip, $filter, $select, $orderby, $count, null);
        Type localVarReturnType = new TypeToken<AbsenceQueryModel>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getListAsync(Integer $top, Integer $skip, String $filter, List<String> $select, String $orderby, Boolean $count, final ApiCallback<AbsenceQueryModel> _callback) throws ApiException {
    ...
    public class GetListRequestBuilder {
         ...
         */
        public AbsenceQueryModel execute() throws ApiException {
            ApiResponse<AbsenceQueryModel> localVarResp = getListWithHttpInfo($top, $skip, $filter, $select, $orderby, $count);
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getList request with HTTP info returned
         * @return ApiResponse&lt;AbsenceQueryModel&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<AbsenceQueryModel> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<AbsenceQueryModel> _callback) throws ApiException {
    ...
    private okhttp3.Call updateByIdCall(String id, UpdateAbsenceCommand updateAbsenceCommand, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = updateAbsenceCommand;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateByIdValidateBeforeCall(String id, UpdateAbsenceCommand updateAbsenceCommand, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateById(Async)");
        }

        return updateByIdCall(id, updateAbsenceCommand, _callback);

    }


    private ApiResponse<Void> updateByIdWithHttpInfo(String id, UpdateAbsenceCommand updateAbsenceCommand) throws ApiException {
        okhttp3.Call localVarCall = updateByIdValidateBeforeCall(id, updateAbsenceCommand, null);
        return localVarApiClient.execute(localVarCall);
    }

    private okhttp3.Call updateByIdAsync(String id, UpdateAbsenceCommand updateAbsenceCommand, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateByIdValidateBeforeCall(id, updateAbsenceCommand, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    ...
    public class UpdateByIdRequestBuilder {
         ...
         */
        public UpdateByIdRequestBuilder narrative(String narrative) {
            this.narrative = narrative;
            return this;
        }
        ...
        /**
         * Set id
         * @param id The ID of the Absence. &lt;br /&gt;  Must exist in the Attendance Absences Service. (optional)
         * @return UpdateByIdRequestBuilder
         */
         ...
         */
        public okhttp3.Call buildCall(final ApiCallback _callback) throws ApiException {
            UpdateAbsenceCommand updateAbsenceCommand = buildBodyParams();
            return updateByIdCall(id, updateAbsenceCommand, _callback);
        }

        private UpdateAbsenceCommand buildBodyParams() {
            UpdateAbsenceCommand updateAbsenceCommand = new UpdateAbsenceCommand();
            updateAbsenceCommand.narrative(this.narrative);
            updateAbsenceCommand.startDate(this.startDate);
            updateAbsenceCommand.endDate(this.endDate);
            updateAbsenceCommand.id(this.id);
            return updateAbsenceCommand;
        }
        ...
        public void execute() throws ApiException {
            UpdateAbsenceCommand updateAbsenceCommand = buildBodyParams();
            updateByIdWithHttpInfo(id, updateAbsenceCommand);
        }
        ...
        public ApiResponse<Void> executeWithHttpInfo() throws ApiException {
            UpdateAbsenceCommand updateAbsenceCommand = buildBodyParams();
            return updateByIdWithHttpInfo(id, updateAbsenceCommand);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<Void> _callback) throws ApiException {
            UpdateAbsenceCommand updateAbsenceCommand = buildBodyParams();
            return updateByIdAsync(id, updateAbsenceCommand, _callback);
        }
    }
     ...
     * ![Beta](https://img.shields.io/badge/Status-Beta-yellow) &lt;b&gt;This API request method is currently in beta testing.&lt;/b&gt; To gain access to use this method, please contact &lt;a href&#x3D;&#39;mailto:hrapi@iris.co.uk&#39;&gt;hrapi@iris.co.uk.&lt;/a&gt;
     * @param id The ID of the Absence to update. (required)
     * @return UpdateByIdRequestBuilder
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
