...
public class CreateJobCommand {
  ...
  public CreateJobCommand jobTitle(String jobTitle) {
  ...
  **/
  ...
  public CreateJobCommand classification(String classification) {
  ...
  **/
  ...
  public CreateJobCommand startDate(OffsetDateTime startDate) {
  ...
  **/
  ...
  public CreateJobCommand endDate(OffsetDateTime endDate) {
  ...
  **/
  ...
  public CreateJobCommand workingCalendar(String workingCalendar) {
  ...
  **/
  ...
  public CreateJobCommand lineManagerId(String lineManagerId) {
  ...
  **/
  ...
  public CreateJobCommand hierarchyNodeId(String hierarchyNodeId) {
  ...
  **/
  ...
  public CreateJobCommand active(Boolean active) {
  ...
  **/
  ...
  public CreateJobCommand salary(Double salary) {
  ...
  **/
  ...
  public CreateJobCommand employeeId(String employeeId) {
  ...
  **/
  ...
  public CreateJobCommand contract(String contract) {
  ...
  **/
  ...
  public CreateJobCommand payFrequency(String payFrequency) {
  ...
  **/
  ...
  public CreateJobCommand payBasis(String payBasis) {
  ...
  **/
  ...
  public CreateJobCommand fullTimeEquivalent(Double fullTimeEquivalent) {
  ...
  **/
  ...
  public CreateJobCommand changeReason(String changeReason) {
  ...
  **/
  ...
  public CreateJobCommand nextIncrementDate(OffsetDateTime nextIncrementDate) {
  ...
  **/
  ...
  public CreateJobCommand timesheetLocation(String timesheetLocation) {
  ...
  **/
  ...
  public CreateJobCommand timesheetLunchDuration(String timesheetLunchDuration) {
  ...
  **/
  ...
  public CreateJobCommand expenseSubmissionFrequency(String expenseSubmissionFrequency) {
  ...
  **/
  ...
  public CreateJobCommand costCentre(String costCentre) {
  ...
  **/
  ...
  public CreateJobCommand jobFamily(String jobFamily) {
  ...
  **/
  ...
  public CreateJobCommand apprenticeUnder25(Boolean apprenticeUnder25) {
  ...
  **/
  ...
  public CreateJobCommand apprenticeshipEndDate(OffsetDateTime apprenticeshipEndDate) {
  ...
  **/
  ...
  public CreateJobCommand contractEndDate(OffsetDateTime contractEndDate) {
  ...
  **/
  ...
  public CreateJobCommand normalHours(Double normalHours) {
  ...
  **/
  ...
  public CreateJobCommand realTimeInformationIrregularFrequency(String realTimeInformationIrregularFrequency) {
  ...
  **/
  ...
  public CreateJobCommand noticePeriod(String noticePeriod) {
  ...
  **/
   ...
   * @return the CreateJobCommand instance itself
   */
  public CreateJobCommand putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CreateJobCommand createJobCommand = (CreateJobCommand) o;
    return Objects.equals(this.jobTitle, createJobCommand.jobTitle) &&
        Objects.equals(this.classification, createJobCommand.classification) &&
        Objects.equals(this.startDate, createJobCommand.startDate) &&
        Objects.equals(this.endDate, createJobCommand.endDate) &&
        Objects.equals(this.workingCalendar, createJobCommand.workingCalendar) &&
        Objects.equals(this.lineManagerId, createJobCommand.lineManagerId) &&
        Objects.equals(this.hierarchyNodeId, createJobCommand.hierarchyNodeId) &&
        Objects.equals(this.active, createJobCommand.active) &&
        Objects.equals(this.salary, createJobCommand.salary) &&
        Objects.equals(this.employeeId, createJobCommand.employeeId) &&
        Objects.equals(this.contract, createJobCommand.contract) &&
        Objects.equals(this.payFrequency, createJobCommand.payFrequency) &&
        Objects.equals(this.payBasis, createJobCommand.payBasis) &&
        Objects.equals(this.fullTimeEquivalent, createJobCommand.fullTimeEquivalent) &&
        Objects.equals(this.changeReason, createJobCommand.changeReason) &&
        Objects.equals(this.nextIncrementDate, createJobCommand.nextIncrementDate) &&
        Objects.equals(this.timesheetLocation, createJobCommand.timesheetLocation) &&
        Objects.equals(this.timesheetLunchDuration, createJobCommand.timesheetLunchDuration) &&
        Objects.equals(this.expenseSubmissionFrequency, createJobCommand.expenseSubmissionFrequency) &&
        Objects.equals(this.costCentre, createJobCommand.costCentre) &&
        Objects.equals(this.jobFamily, createJobCommand.jobFamily) &&
        Objects.equals(this.apprenticeUnder25, createJobCommand.apprenticeUnder25) &&
        Objects.equals(this.apprenticeshipEndDate, createJobCommand.apprenticeshipEndDate) &&
        Objects.equals(this.contractEndDate, createJobCommand.contractEndDate) &&
        Objects.equals(this.normalHours, createJobCommand.normalHours) &&
        Objects.equals(this.realTimeInformationIrregularFrequency, createJobCommand.realTimeInformationIrregularFrequency) &&
        Objects.equals(this.noticePeriod, createJobCommand.noticePeriod)&&
        Objects.equals(this.additionalProperties, createJobCommand.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(jobTitle, classification, startDate, endDate, workingCalendar, lineManagerId, hierarchyNodeId, active, salary, employeeId, contract, payFrequency, payBasis, fullTimeEquivalent, changeReason, nextIncrementDate, timesheetLocation, timesheetLunchDuration, expenseSubmissionFrequency, costCentre, jobFamily, apprenticeUnder25, apprenticeshipEndDate, contractEndDate, normalHours, realTimeInformationIrregularFrequency, noticePeriod, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateJobCommand {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateJobCommand
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateJobCommand.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateJobCommand is not found in the empty JSON string", CreateJobCommand.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateJobCommand.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateJobCommand' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateJobCommand> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateJobCommand.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateJobCommand>() {
           @Override
           public void write(JsonWriter out, CreateJobCommand value) throws IOException {
           ...
           @Override
           public CreateJobCommand read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CreateJobCommand instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CreateJobCommand given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CreateJobCommand
  * @throws IOException if the JSON string is invalid with respect to CreateJobCommand
  */
  public static CreateJobCommand fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateJobCommand.class);
  }

 /**
  * Convert an instance of CreateJobCommand to an JSON string
  *
  * @return JSON string
  */
