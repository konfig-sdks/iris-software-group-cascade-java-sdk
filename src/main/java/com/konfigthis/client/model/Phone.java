 ...
 */
@ApiModel(description = "A Phone Number with Ownership and Type properties")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Phone {
  ...
  public Phone ownership(Ownership ownership) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The Phone Number value. <br />  Cascade Source:  <br />  Ownership = Organization, Type = Landline Then [Employee].[WorkPhone] <br />  Ownership = Organization, Type = Mobile Then [Employee].[WorkMobilePhoneNumber] <br />  Ownership = Personal, Type = Landline Then [EmployeeHomeAddress].[Phone] <br />  Ownership = Personal, Type = Mobile Then [EmployeeHomeAddress].[MobilePhone]")
  ...
  public boolean equals(Object o) {
    ...
    Phone phone = (Phone) o;
    return Objects.equals(this.ownership, phone.ownership) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(ownership, type, value, additionalProperties);
  }
