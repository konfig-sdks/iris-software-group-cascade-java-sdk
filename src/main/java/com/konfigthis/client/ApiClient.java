...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.iris.co.uk/hr/v2";
    private String tokenUrl = "https://api.iris.co.uk/oauth2/v1/token";
    ...
    private RetryingOAuth setupOauth(String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        authentications.put("Bearer", oauth);
        return oauth;
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.iris.co.uk/hr/v2)
     ...
     * Set token url
     *
     * @param tokenUrl Token URL for oauth (e.g https://api.iris.co.uk/oauth2/v1/token)
     * @return An instance of OkHttpClient
     */
